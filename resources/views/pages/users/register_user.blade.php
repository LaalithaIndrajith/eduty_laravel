                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12 border-right">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-sm-2 form-group">
                                    ...
                                    <select class="form-control form-control-lg dynamic mt-2 selectpicker @error('user_title_select') is-invalid @enderror" name="user_title_select" id="user_title_select" data-dependent="user_title_select" data-size="7">
