                ...
                <div class="card-body">
                    <div class="d-flex align-items-center p-5 justify-content-around">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            <a href="{{ route('viewJobTicketList') }}" class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">
                            Total Job Tickets Created
                            </a>
                            <div class="text-primary">
                                <h1 class="display-2 font-weight-bolder">10</h1>
                                {{-- <h6 class="font-size-sm text-success font-weight-bold">Activated</h6> --}}
                            </div>
                            <div class="text-primary">
                                <h1 class="font-size-sm text-primary font-weight-light">Today</h1>
                            </div>
                        </div>
                    </div>
                </div>
