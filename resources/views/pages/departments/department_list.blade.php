            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Department List
                        <span class="d-block text-muted pt-2 font-size-sm">Details of Departments</span>
                    </h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="{{ route('departmentCreationView') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
