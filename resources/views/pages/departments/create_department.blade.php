...
@section('content')
    ...
    {{-- Create Department--}}
    <form method="POST" id="create-new-department-form" action="{{ route('createDepartment') }}" enctype="multipart/form-data">
        @csrf
        <div id="kt_page_sticky_card" class="card card-custom card-sticky">
            <div class="card-header flex-wrap py-3">
                <div class="card-title">
                    <h3 class="card-label">Department Creation
                    <span class="d-block text-muted pt-2 font-size-sm">Create Departments for the system </span></h3>
                </div> 
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('departmentCreationView') }}" class="btn btn-light-danger ml-1"">
                        <span class="svg-icon svg-icon-md">
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12 border-right">
                            ...
                            <div class="row">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <textarea class="form-control @error('dep_address') is-invalid @enderror " type="text" name="dep_address" rows="5"></textarea>
                                    @error('dep_address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <span class="switch">
                                        <label>
                                            <input type="checkbox" checked="checked" name="dep_status" id="dep_status" value="1" />
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8 col-sm-10 form-group">
                                    ...
                                    <input id="dep_mail" type="dep_mail" class="form-control @error('dep_mail') is-invalid @enderror" name="dep_mail" />
                                    @error('dep_mail')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row d-flex justify-content-center mt-3">
                                <div class="col-lg-8 col-sm-10 form-group">
                                    ...
                                    <input id="dep_telephone" type="text" class="form-control form-control @error('dep_telephone') is-invalid @enderror" placeholder="Enter Telephone Number" name="dep_telephone" />
                                    @error('dep_telephone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById('create-new-department-form'), {
                fields: {
                    dep_code: {
                        validators: {
                            notEmpty: {
        ...
        let departmentCreationEvent = <?php 
            if(session()->has('departmentCreation')){
                echo json_encode(session()->get('departmentCreation'));   
            }else{
                echo json_encode('');
            } 
            ?>;

        (departmentCreationEvent != '') ? loadToaster(departmentCreationEvent) : ''
