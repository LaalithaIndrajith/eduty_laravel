...
@section('content')
    ...
    <form method="POST" id="edit-client-form" action="{{ route('editClient', $client->client_id) }}" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-12 border-right">
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-sm-2 form-group">
                                    ...
                                    <select class="form-control form-control-lg dynamic selectpicker @error('client_title_select') is-invalid @enderror" name="client_title_select" id="client_title_select" data-dependent="client_title_select" data-size="7">
                                        ...
                                        <option value="Mr" {{ ($client->client_title == 'Mr') ? 'selected' : '' }}>Mr</option>
                                        <option value="Miss" {{ ($client->client_title == 'Miss') ? 'selected' : '' }}>Miss</option>
                                        <option value="Mrs" {{ ($client->client_title == 'Mrs') ? 'selected' : '' }}>Mrs</option>
                                    </select>
                                ...
                                <div class="col-lg-5 col-sm-6 form-group">
                                    ...
                                    <input id="client_fname" type="text" class="form-control @error('client_fname') is-invalid @enderror" placeholder="Enter First Name" name="client_fname" value="{{ $client->client_fname }}" />
                                    @error('client_fname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-5 col-sm-6 form-group">
                                    ...
                                    <input id="client_lname" type="text" class="form-control @error('client_lname') is-invalid @enderror" placeholder="Enter Last Name" name="client_lname" value="{{ $client->client_lname }}" />
                                    @error('client_lname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row d-flex justify-content-start">
                                <div class="col-lg-6 form-group">
                                    ...
                                    <input id="client_nic" type="text" class="form-control @error('client_nic') is-invalid @enderror" placeholder="Enter NIC" name="client_nic" value="{{ $client->client_nic }}" />
                                    @error('client_nic')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-6 form-group">
                                    ...
                                    <textarea class="form-control @error('client_address') is-invalid @enderror " type="text" name="client_address" rows="5">
                        ...
                        <div class="col-lg-5 col-md-6 col-sm-12">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8 col-sm-10 form-group">
                                    ...
                                    <input id="client_telephone" type="text" class="form-control form-control @error('client_telephone') is-invalid @enderror" placeholder="Enter Telephone Number" name="client_telephone" value="{{ $client->client_contact }}" />
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8 col-sm-10 form-group">
                                    ...
                                    <input id="client_email" type="client_email" class="form-control @error('email') is-invalid @enderror" placeholder="Enter Email Address" name="client_email" value="{{ $client->client_email }}"/>
                                    @error('client_email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
@section('scripts')
    ...
    <script>
        ...
        document.getElementById('edit-client-form'), {
                fields: {
                    client_title_select: {
                        validators: {
                            notEmpty: {
        ...
        let clientEditEvent = <?php 
            if(session()->has('clientEdit')){
                echo json_encode(session()->get('clientEdit'));   
            }else{
                echo json_encode('');
            } 
            ?>;

        (clientEditEvent != '') ? loadToaster(clientEditEvent) : '' ;
